...
const sceneDescs = [
    ...
    new Sly1LevelSceneDesc("uw_c2_final", "The Fire Down Below", 0x8b09c0),
    ...
    new Sly1LevelSceneDesc("s_hub", "Inside the Stronghold", 0xf22d8),
    ...
    new Sly1LevelSceneDesc("s_boss", "Flame Fu!", 0x3b1bdc),
